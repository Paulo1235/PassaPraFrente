  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        const userResponse = await fetch(`${BACKEND_URL}/api/protected-route`, { credentials: "include" });
        ...
        <div className="w-full sm:w-1/2 bg-white rounded-2xl px-6 py-6 sm:px-8 sm:py-8">
          ...
          <form onSubmit={formik.handleSubmit}>
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border ${formik.touched.email && formik.errors.email ? "border-red-500" : "border-txtp"} rounded-md focus:outline-none focus:ring-1 focus:ring-txtp`}
                />
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={formik.handleChange}
                    onBlur={formik.handleBlur}
                    className={`w-full px-3 py-2 border ${formik.touched.password && formik.errors.password ? "border-red-500" : "border-txtp"} rounded-md focus:outline-none focus:ring-1 focus:ring-txtp`}
                  />
            ...
            <div className="flex justify-end">
              <a href="RecoverPass" className="text-sm text-txts hover:underline">Alterar Palavra-Passe</a>
            </div>
            <div className="mt-8 space-y-4">
              <button type="submit" className="w-full text-white py-2 px-4 bg-btns hover:bg-[#c2a478] text-black font-medium rounded-md transition duration-200">
                Entrar
              </button>
              <p className="text-center text-sm">Novo aqui? <a href="SignIn" className="text-txtp hover:underline">Criar Conta</a></p>
            </div>
          </form>
        </div>
      </div>
